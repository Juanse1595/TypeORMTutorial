...
var userRepository = app_data_source_1.myDataSource.getRepository(user_entity_1.User);
...
app.post("/users", function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            results = userRepository.save(user);
            return [2 /*return*/, res.send(results)];
        });
    });
});
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    results = userRepository.save(userToUpdate);
                    return [2 /*return*/, res.send(results)];
            }
        });
    });
